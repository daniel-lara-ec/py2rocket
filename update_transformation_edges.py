#!/usr/bin/env python3
"""
Script para actualizar todas las funciones de transformación para usar _get_origin_and_relation
"""

import re

# Leer el archivo
with open("py2rocket/core/transformation.py", "r") as f:
    content = f.read()
...
with open("py2rocket/core/transformation.py", "w") as f:
