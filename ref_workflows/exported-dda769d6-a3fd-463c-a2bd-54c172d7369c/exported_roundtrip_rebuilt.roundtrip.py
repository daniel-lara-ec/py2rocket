...
def workflow():
    ...
    csv = raw_step(
        ...
        ui_configuration={'position': {'x': 271.0, 'y': 260.0}},
    ...
    f_datos = raw_step(
        ...
        inputs=csv,
        ui_configuration={'position': {'x': 454.0, 'y': 258.0}},
        last_modified="2026-02-11T01:10:36Z"
    )
    transformacion = raw_step(
        name="Transformacion",
        class_name='TriggerTransformStep',
        configuration={'sql': 'SELECT *\r\nFROM F_Datos', 'genAIMetadataTableDescription': '', 'debugOptions': '{"executeStepAutoDebug":true,"executeStepDebug":true,"mockType":"NoMock"}', 'isSaved': True},
        inputs=f_datos,
        outputs_writer=[{'saveMode': 'Append', 'outputStepName': 'Print', 'tableName': '', 'discardTableName': '', 'extraOptions': {'checkIfEmpty': False}}],
        ui_configuration={'position': {'x': 641.0, 'y': 262.0}},
        last_modified="2026-02-11T01:10:31Z"
    )
    ...
    print = raw_step(
        ...
        ui_configuration={'position': {'x': 813.0, 'y': 261.0}},
        last_modified="2026-02-11T01:10:45Z",
